...
(
	...
	CONSTRAINT team_member_team_id_fkey FOREIGN KEY (team_id) REFERENCES svc.team (team_id) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION,
	CONSTRAINT team_member_user_id_fkey FOREIGN KEY (user_id) REFERENCES svc.user (user_id) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION
)
