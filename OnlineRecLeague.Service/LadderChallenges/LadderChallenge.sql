...
GRANT ALL ON TABLE public.ladder_challenge TO onlinerecleague_dbuser;

GRANT INSERT, SELECT, UPDATE, DELETE ON TABLE public.ladder_challenge TO onlinerecleague_dbuser;

-- Index: ladder_challenge_challenged_team_id_idx

DROP INDEX IF EXISTS public.ladder_challenge_challenged_team_id_idx;
...
DROP INDEX IF EXISTS public.ladder_challenge_challenger_team_id_idx;
...
DROP INDEX IF EXISTS public.ladder_challenge_ladder_id_idx;
