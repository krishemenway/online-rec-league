...
ALTER TABLE public.game OWNER to onlinerecleague_dbuser;
...
CREATE UNIQUE INDEX game_uri_path_uidx ON public.game USING btree (uri_path COLLATE pg_catalog."default") TABLESPACE pg_default;
